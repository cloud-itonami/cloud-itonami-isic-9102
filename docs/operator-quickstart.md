# Operator Quickstart — Museums activities and operation of historical sites and bu...

Shortest path from clone to a verified local dry-run for **ISIC 9102** (`cloud-itonami-isic-9102`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-9102.git
cd cloud-itonami-isic-9102
```
...
- Blueprint governor key: `collections-governor`
- Likely source path: `museum.governor.cljc`
